...
public class Bloqueo {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "bloqueos_seq")
    @SequenceGenerator(name = "bloqueos_seq", sequenceName = "beworking.bloqueos_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Long id;
