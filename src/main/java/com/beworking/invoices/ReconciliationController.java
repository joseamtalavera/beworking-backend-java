    ...
    public ResponseEntity<List<Map<String, Object>>> getLatest() {
        List<Map<String, Object>> rows = jdbcTemplate.queryForList("""
            SELECT
                ...
                COALESCE(r.missing_invoices::text, '[]')  as missing_invoices,
                COALESCE(r.past_due_subs::text, '[]')     as past_due_subs,
                COALESCE(r.db_only_subs::text, '[]')      as db_only_subs,
                COALESCE(r.stripe_only_subs::text, '[]')  as stripe_only_subs,
                ...
                COALESCE(r.stripe_closed_db_pending::text, '[]') as stripe_closed_db_pending,
                r.created_at,
                COALESCE((
